...
class Controls(ControlsExt):
  ...
  def state_control(self):
    ...
    # Check if downstream EV power limiter was saturating last cycle (anti-windup)
    ev_power_saturated = getattr(self.CI.CC, 'ev_power_saturation', 0.0) > 0.01
    actuators.accel = float(self.LoC.update(CC.longActive, CS, long_plan.aTarget, long_plan.shouldStop, pid_accel_limits,
                                            ev_power_saturated=ev_power_saturated))
