...
class Calibrator:
  def __init__(self, param_put: bool = False):
    ...
    # Fix C: one-shot user-requested reset -> show as "Recalibrating" instead of "Calibrating" (reserved for
    # first-time setup). The flag is consumed here so it doesn't persist beyond the next restart.
    if param_put:
      try:
