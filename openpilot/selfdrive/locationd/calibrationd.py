...
class Calibrator:
  def __init__(self, param_put: bool = False):
    ...
    # Live-readable bypass flag for the box check. Refreshed in update_status() at ~1 Hz so the user can toggle mid-drive.
    ...
    # One-shot user-requested reset -> start in "recalibrating" rather than first-time "calibrating". Flag is consumed here.
    if param_put:
      try:
