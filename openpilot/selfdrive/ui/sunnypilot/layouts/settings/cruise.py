...
class CruiseLayout(Widget):
  ...
  def _initialize_items(self):
    ...
    self.ev_power_limit_toggle = toggle_item_sp(
      ...
      description=tr("Limit positive longitudinal power to keep the vehicle in EV mode. The vehicle may slow down on grades to stay within the power limit."),
    ...
    self.sva_toggle = toggle_item_sp(
      ...
      description=tr("More aggressive braking when approaching stopped vehicles. Prioritizes safe 5ft stopping distance over ride comfort."),
