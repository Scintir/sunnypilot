...
class SunnylinkLayout(Widget):
  ...
  def _initialize_items(self):
    ...
    self._ev_power_limit_toggle = toggle_item_sp(
      ...
      description=tr("Limit positive longitudinal power to keep the vehicle in EV mode. Synced with Cruise settings."),
    ...
    self._sva_toggle = toggle_item_sp(
      ...
      description=tr("More aggressive braking when approaching stopped vehicles. Synced with Cruise settings."),
